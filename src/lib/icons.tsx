// Iconos SVG inline (estilo Lucide) para el panel web /admin.
// Espejo en React del set usado por la extensión (ticket_lock_wxt/lib/icons.ts) —
// proyectos distintos (alias @/ apunta a carpetas separadas), de ahí la duplicación.
